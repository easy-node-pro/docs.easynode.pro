...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
    <Tabs.Tab>
        ...
        ~/tmp.gen.keypair
        ~/staker_memo
        /data/fractal/mainnet/node.mnemonic
        /data/fractal/mainnet/mainnet_node.key
        /data/fractal/mainnet/tendermint/config/
        ```
    </Tabs.Tab>
    <Tabs.Tab>
        ```text copy
        ~/tmp.gen.keypair
        ~/staker_memo
        /data/fractal/testnet/node.mnemonic
        /data/fractal/testnet/testnet_node.key
        /data/fractal/testnet/tendermint/config/
        ```
    </Tabs.Tab>
</Tabs>
...
Note: This is the old method, **the toolbox works best to migrate efficiently**. This guide will assume you have a new server online and synced up to the blockchain on a temporary brand new wallet. You can use the [validator toolbox](/fractal/toolbox) install to get to this point and then take over manually.  
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
    <Tabs.Tab>
        ```text copy
        cd ~/ && wget -O migrate_mainnet.sh https://raw.githubusercontent.com/FindoraNetwork/fractal-toolbox/main/src/bin/main/migrate_mainnet.sh && bash -x migrate_mainnet.sh
        ```
    </Tabs.Tab>
    <Tabs.Tab>
        ```text copy
        cd ~/ && wget -O migrate_testnet.sh https://raw.githubusercontent.com/FindoraNetwork/fractal-toolbox/main/src/bin/main/migrate_testnet.sh && bash -x migrate_testnet.sh
        ```
    </Tabs.Tab>
</Tabs>
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
    <Tabs.Tab>
        ```text copy
        docker stop findorad && docker rm findorad && rm -rf /data/fractal/mainnet/tendermint/config/addrbook.json
        ```
    </Tabs.Tab>
    <Tabs.Tab>
        ```text copy
        docker stop findorad && docker rm findorad && rm -rf /data/fractal/testnet/tendermint/config/addrbook.json
        ```
    </Tabs.Tab>
</Tabs>
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
    <Tabs.Tab>
        ```text copy
        fn setup -S https://prod-mainnet.prod.fractal.org
        fn setup -O /data/fractal/mainnet/node.mnemonic
        fn setup -K /data/fractal/mainnet/tendermint/config/priv_validator_key.json
        ```
    </Tabs.Tab>
    <Tabs.Tab>
        ```text copy
        fn setup -S https://prod-testnet.prod.fractal.org
        fn setup -O /data/fractal/testnet/node.mnemonic
        fn setup -K /data/fractal/testnet/tendermint/config/priv_validator_key.json
        ```
    </Tabs.Tab>
</Tabs>
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
    <Tabs.Tab>
        ...
        export LIVE_VERSION=$(curl -s https://${ENV}-${NAMESPACE}.${ENV}.fractal.org:8668/version | awk -F\  '{print $2}')
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
    <Tabs.Tab>
        ```text copy
        wget https://raw.githubusercontent.com/FindoraNetwork/fractal-toolbox/main/src/bin/main/update_mainnet.sh -O update_mainnet.sh && bash -x update_mainnet.sh
        ```  
    </Tabs.Tab>
    <Tabs.Tab>
        ```text copy
        wget https://raw.githubusercontent.com/FindoraNetwork/fractal-toolbox/main/src/bin/main/update_testnet.sh -O update_testnet.sh && bash -x update_testnet.sh
        ```  
    </Tabs.Tab>
</Tabs>
