...
>
  <Tabs.Tab>
    ...
    - [Manual Method](https://docs.fractal.org/validator-materials/node-setup-guides/manual-setup) - Use the Fractal docs site to install. This is recommended for first time installers and people not familliar with Linux.
    - [Script Method](https://docs.fractal.org/validator-materials/node-setup-guides/automated-setup) - Our take on the "Automated Install" on the page above. We've made it smoother and added a lot of bells and whistles.
    - [Validator Toolbox Method](https://docs.fractal.org/validator-materials/node-setup-guides/toolbox-setup) - Official Fractal Validator Setup & Management Toolkit.
  </Tabs.Tab>
  <Tabs.Tab>
    Configuring a Fractal node can be straight forward with either method we cover here & a cloud host provider. If you manually install Fractal from their docs site or use home hardware here's some extra things to know:
    ...
    - Pull fractal.sh script and run it
  ...
  <Tabs.Tab>
    ...
    - Answer questions in the official Fractal support channels
    - Work on getting more delegations, you'll need it
    - Monitor stats non stop on [Smart Stake's Next Election site](https://fractal.smartstake.io/)
...
### Web Firewall Config
You'll need port 22 for SSH connections, and the following ports should be open for Fractal.
```text copy
22
8545
8667-8669
...
## Fractal Components
Fractal has two components: A docker container that runs the validator software and has your private validator info & `fn` an application that contains your staking wallet and performs blockchain commands.
